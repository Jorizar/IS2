...
public class RegistroContable {
    ...
    public RegistroContable(String idRegistro, String cuentaContable, String concepto, String tipoOperacion, double monto, boolean estadoBalance) {
    ...
    public boolean isEstadoBalance() { return estadoBalance; }
    public void setEstadoBalance(boolean estadoBalance) { this.estadoBalance = estadoBalance; }
}