...
public class CuentaBancaria {
	...
	public CuentaBancaria(String iban, String nombreBanco, String sucursal, String tipoCuenta, String moneda,
			double saldo, String estadoValidacion, Banco bancoAsociado) {
		this.iban = iban;
