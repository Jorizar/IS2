...
public class VueloService {
	...
	public boolean crearVuelo(TransferVuelo vuelo, List<TransferCalendario> calendarios, String idOperador)
		...
		if (calendarios != null) {
			for (TransferCalendario c : calendarios) {
				...
				TransferCalendario calendario = new TransferCalendario(c.getFechaInicio(), c.getFechaFin(),
						c.getHoraSalida(), c.getHoraLlegada(), vuelo.getIdVuelo());
	...
	private void validarCalendarios(List<TransferCalendario> calendarios) throws ValidationException {
	...
	private void validarVuelo(TransferVuelo vuelo) throws ValidationException {
		...
		if (vuelo.getIdVuelo() == null || vuelo.getIdVuelo().isBlank() || vuelo.getOrigen() == null
				|| vuelo.getOrigen().isBlank() || vuelo.getDestino() == null || vuelo.getDestino().isBlank()) {
